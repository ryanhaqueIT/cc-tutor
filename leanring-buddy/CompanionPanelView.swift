        ...
        if companionManager.hasCompletedOnboarding && companionManager.allPermissionsGranted {
            ...
            VStack(alignment: .leading, spacing: 4) {
                Text("Drop your email to get started.")
                    .font(.system(size: 12, weight: .medium))
                    .foregroundColor(DS.Colors.textSecondary)
                Text("We'll keep you posted on new Claude Code tutorials and tips.")
                    .font(.system(size: 11))
                    .foregroundColor(DS.Colors.textTertiary)
            }
            .frame(maxWidth: .infinity, alignment: .leading)
        } else if companionManager.allPermissionsGranted {
            Text("You're all set. Hit Start to meet your Claude Code tutor.")
                .font(.system(size: 12, weight: .medium))
                .foregroundColor(DS.Colors.textSecondary)
                .frame(maxWidth: .infinity, alignment: .leading)
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("Some permissions were revoked. Grant all four below to keep using CC Tutor.")
                    .font(.system(size: 11))
                    .foregroundColor(DS.Colors.textTertiary)
            ...
            VStack(alignment: .leading, spacing: 6) {
                Text("Welcome to CC Tutor")
                    .font(.system(size: 12, weight: .bold))
                    .foregroundColor(DS.Colors.textSecondary)

                Text("Your personal companion for learning Claude Code — the agentic coding CLI from Anthropic. Ask questions, get guided walkthroughs, and learn by doing.")
                    .font(.system(size: 11))
                    .foregroundColor(DS.Colors.textTertiary)
                    .fixedSize(horizontal: false, vertical: true)

                Text("Nothing runs in the background. CC Tutor only takes a screenshot when you press the hot key, so it can see what you're working on and give relevant help.")
                    .font(.system(size: 11))
        ...
        Button(action: {
            ...
            HStack(spacing: 8) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text("Open the official documentation in your browser.")
                        .font(.system(size: 10))
                        .foregroundColor(DS.Colors.textTertiary)
                }
            }
